 ...
 *
 * $Id: config.h,v 1.141 2001/12/04 00:51:42 wcampbel Exp $
 */
...
/* MAX_MULTI_MESSAGES
 * Maximum number of recipients to a PRIVMSG.  Any more than
 * MAX_MULTI_MESSAGES will not be sent.  If MAX_MULTI_MESSAGES is 1, then
